...
<body>
    ...
    <div class="wrapper">
        ...
        <ul class="navigation">
            ...
            <li <?php if ($this->checkForActiveController($filename, "songs")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>songs/index">songs</a>
            </li>
 
            <li <?php if ($this->checkForActiveController($filename, "blog")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>blog/index">blogs</a>
            </li>
        
            <li <?php if ($this->checkForActiveController($filename, "photo")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>photo/index">photo</a>
            </li>
